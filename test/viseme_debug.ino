...
void analyzeVisemes() {
  ...
  if (maxVal == ah_amplitude) dominant = "AH";
  else if (maxVal == ee_amplitude) dominant = "EE";
  else if (maxVal == oh_amplitude) dominant = "OH";
  else if (maxVal == oo_amplitude) dominant = "OO";
  else if (maxVal == th_amplitude) dominant = "TH";
